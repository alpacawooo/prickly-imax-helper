...
```bash
cd "$HOME/Downloads"; f='prickly-imax-helper-0.2.3.tar.gz'; expected='6a158b0adb1c836e701b4b42470b22aab3e1c93532e5885f0f8c0f940234f9db'; actual="$(shasum -a 256 "$f" | awk '{print $1}')"; if [ "$actual" = "$expected" ]; then tar -xzf "$f" && open prickly-imax-helper-0.2.3/scripts/Install.command; else echo '체크섬 불일치: 설치 중단'; fi
```
