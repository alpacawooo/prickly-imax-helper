...
```bash
cd "$HOME/Downloads"; f='prickly-imax-helper-0.2.3.tar.gz'; expected='193809cee2e113b32036e1a54b7731d396b5b2a1b4c8586557c1fd1f98967747'; actual="$(shasum -a 256 "$f" | awk '{print $1}')"; if [ "$actual" = "$expected" ]; then tar -xzf "$f" && open prickly-imax-helper-0.2.3/scripts/Install.command; else echo '체크섬 불일치: 설치 중단'; fi
```
