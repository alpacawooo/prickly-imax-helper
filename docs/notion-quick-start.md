...
```bash
cd "$HOME/Downloads"; f='prickly-imax-helper-0.2.3.tar.gz'; expected='5f7b60524bd8513feb45f6e935ca177577fd1dd125ef0bb1763b7117f4fafb07'; actual="$(shasum -a 256 "$f" | awk '{print $1}')"; if [ "$actual" = "$expected" ]; then tar -xzf "$f" && open prickly-imax-helper-0.2.3/scripts/Install.command; else echo '체크섬 불일치: 설치 중단'; fi
```
