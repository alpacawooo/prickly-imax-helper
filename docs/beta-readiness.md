...
- [x] Apple Mail script compiles and setup requires a successful test message.
...
- [x] Installer, updater, uninstaller, LaunchAgent plist, diagnostic output, and redacted event logs exist.
- [x] Release builder emits a SHA-256 file and rejects missing authorization evidence, a non-public-IP limit scope, or an invalid request rate.
